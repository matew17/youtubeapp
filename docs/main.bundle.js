...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_youtube_service__ = __webpack_require__("../../../../../src/app/services/youtube.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pipes_video_you_tube_pipe__ = __webpack_require__("../../../../../src/app/pipes/video-you-tube.pipe.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_7__pipes_video_you_tube_pipe__["a" /* VideoYouTubePipe */]
        ],
        imports: [
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_0__services_youtube_service__["a" /* YoutubeService */]
        ],
...
module.exports = "<div class=\"container\">\n  <h1>Canal de youtube</h1>\n  <hr>\n\n  <div class=\"card-columns\" *ngIf=\"videos\">\n\n    <div class=\"card\" *ngFor=\"let video of videos\">\n      <img class=\"card-img-top\" [src]=\"video.thumbnails.high.url\" [alt]=\"video.title\">\n      <div class=\"card-body\">\n        <h4 class=\"card-title\">{{video.title}}</h4>\n        <button type=\"button\" class=\"btn tbn-outline-primary btn-clock\" (click)=\"verVideo(video)\">Ver Video</button>\n      </div>\n    </div>\n\n  </div>\n  <button type=\"button\" class=\"btn btn-outline-primary btn-block\" (click)=\"cargarMasVideos()\">\n    Cargar mas videos\n  </button>\n\n</div>\n\n\n<!-- Modal -->\n<div class=\"modal fade\" id=\"youTubeModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\"\n  data-backdrop=\"static\" data-keyword=\"false\">\n  <div class=\"modal-dialog\" role=\"document\">\n\n    <div class=\"modal-content\" *ngIf=\"videoSel\">\n      <div class=\"modal-header\">\n        <h5 class=\"modal-title\" id=\"exampleModalLabel\">{{videoSel.title}}</h5>\n      </div>\n      <div class=\"modal-body\">\n        <iframe width=\"100%\" height=\"300\" [src]=\"videoSel.resourceId.videoId | videoYouTube\" frameborder=\"0\" gesture=\"media\" allow=\"encrypted-media\"\n          allowfullscreen></iframe>\n      </div>\n      <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn btn-secondary\" (click)=\"cerrarModal()\">Cerrar Modal</button>\n      </div>\n    </div>\n  </div>\n</div>"
...
var HomeComponent = (function () {
    function HomeComponent(yS) {
        var _this = this;
        this.yS = yS;
        this.videos = [];
        this.yS.getVideos().subscribe(function (videos) {
            _this.videos = videos;
        });
    }
    ...
    HomeComponent.prototype.cargarMasVideos = function () {
        var _this = this;
        this.yS.getVideos().subscribe(function (videos) {
            (_a = _this.videos).push.apply(_a, videos);
            var _a;
        });
    };
...
HomeComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__services_youtube_service__["a" /* YoutubeService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__services_youtube_service__["a" /* YoutubeService */]) === "function" && _a || Object])
], HomeComponent);
...
module.exports = "<nav class=\"navbar navbar-inverse bg-danger\">\n  <span class=\"navbar-brand mb-0 h1\">YoutubeApp</span>\n</nav>"
...
/***/ "../../../../../src/app/pipes/video-you-tube.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _a;
//# sourceMappingURL=video-you-tube.pipe.js.map
...
var YoutubeService = (function () {
    function YoutubeService(http) {
        ...
        this.apiKey = 'AIzaSyDr4fsFs0o7Tz98V2UD9-sSR2jmD3B2YRc';
        this.playlist = 'UUGRjJrpD2bmk9Ilq6nq80qg';
    }
